...
/*        .p1{
    ...
    <body>
        ...
        <div style="margin: 50px; align-items: center; padding: 50px;background-image: linear-gradient(#ffe9c9, #ffe3d0, #ffb2be); border-radius: 20px; display: flex;"> 
            ...
            <div class="p1"><image style="width:50px; height: 50px;" src="image/location.png"> 
                ...
                <button class="b1"><a href="https://goo.gl/maps/yin1JW8CQkPTjuSj7">Find us on map</a></button>
                </div>
            </div>
